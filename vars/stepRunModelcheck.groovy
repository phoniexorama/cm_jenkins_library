def call() {
    ...
    def pythonContent = libraryResource('scripts/modelcheck.py')

    // Write Python script to a file in the Jenkins workspace
    writeFile(file: 'modelcheck.py', text: pythonContent)

    // Use correct file path separator for Windows
    def pythonScriptPath = "${env.WORKSPACE}\\modelcheck.py"
